...
class Solution {
    ...
    public int maxProfit1(int[] prices, int fee) {
         ...
         *   或者前一天结束的时候手里持有一支股票，即 dp[i−1][1]，这时候要将其卖出，并获得 prices[i] 的收益，但需要支付 fee 的手续费。
         *   因此为了收益最大化，列出如下的转移方程：
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Solution().maxProfit3(new int[]{1, 3, 2, 8, 4, 9}, 2));
    }
}
