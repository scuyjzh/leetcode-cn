...
class Solution {
    ...
    private void dfs(int[] candidates, int begin, int target, List<Integer> path, List<List<Integer>> res) {
        ...
        // 重点理解这里从 begin 开始搜索的语意，不再搜索产生同一层结点已经使用过的 candidate 里的元素
    ...
    public static void main(String[] args) {
        ...
        System.out.println("输出 => " + solution.combinationSum(new int[]{2, 3, 6, 7}, 7));
        System.out.println("输出 => " + solution.combinationSum(new int[]{2, 3, 5}, 8));
    }
}
